...
let ChatbotController = class ChatbotController {
    ...
    async chat(body) {
        try {
            ...
            console.log('Incoming chat request:', { userId, sessionId, message });
            return await this.chatbotService.chat(userId, sessionId, message);
        }
        catch (e) {
            console.error('CHAT ERROR:', e);
            throw new common_1.HttpException(e.message || 'Lỗi server nội bộ', common_1.HttpStatus.INTERNAL_SERVER_ERROR);
        }
    }
